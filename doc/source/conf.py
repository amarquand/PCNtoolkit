...
sys.path.insert(0, os.path.abspath('../../pcntoolkit/util'))
...
latex_documents = [
    (master_doc, 'PCNtoolkitdoc.tex', u'PCNtoolkit documentation',
...
man_pages = [
    (master_doc, 'PCNtoolkitdoc', u'PCNtoolkit documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PCNtoolkitdoc', u'PCNtoolkit documentationn',
     author, 'PCNtoolkitdoc', 'One line description of project.',
     'Miscellaneous'),
]
