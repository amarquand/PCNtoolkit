...
sys.path.insert(0, os.path.abspath('../../pcntoolkit/math_function'))
sys.path.insert(0, os.path.abspath('../../pcntoolkit/regression_model'))
...
author = u'Saige Rutherford, Andre F. Marquand, Stijn de Boer'
