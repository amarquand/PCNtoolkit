...
wdir = '/home/mrstats/seykia/data/nispat_test/'
...
python_path = '/home/mrstats/seykia/.conda/envs/python3/bin/python'
normative_path = '/home/mrstats/seykia/Code/nispat/nispat/normative.py'
job_name = 'nmp_test'
batch_size = 10
memory = '4gb'
duration = '01:00:00'
...
execute_nm(wdir, python_path, normative_path, job_name, covfile,  respfile,
           ...
           cv_folds=cvfolds, log_path=wdir)#, alg='rfa')#, configparam=4)
