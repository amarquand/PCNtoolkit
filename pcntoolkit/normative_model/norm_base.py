...
class NormBase(ABC):
    ...
    template_reg_conf : RegConf
        Regression configuration used to create all regression models.
    ...
    def has_batch_effect(self) -> bool:
        ...
        Returns:
            bool: True if the model has a batch effect, False otherwise.
        """
        return self.focused_model.has_batch_effect
