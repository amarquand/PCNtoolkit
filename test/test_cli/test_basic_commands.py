...
from pcntoolkit.math_functions.basis_function import BsplineBasisFunction, PolynomialBasisFunction
from pcntoolkit.math_functions.warp import WarpAffine, WarpCompose, WarpSinhArcsinh
...
class TestBasicCLI:
    ...
    def test_simple_blr_cli(self):
        ...
        assert not model.template_regression_model.intercept_var
    ...
    def test_blr_cli_with_fixed_effects(self):
        ...
        assert model.template_regression_model.intercept_var
